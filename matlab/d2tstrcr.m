...
[ier, nbox, nboxes, isource, laddr, nlev, center, size, itarget, w, lused] = fmm2d(mex_id_, ier, source, nsource, nbox, nboxes, isource, laddr, nlev, center, size, target, ntarget, itarget, w, lw, lused, 1, 1, 1, 1, 1, 1, 1, 1);
